...
function modTreeMenu($module) {
    ...
    $str .= "<div class=\"siteNavHistoryDiv\">\n";
    $str .= "<a href=\"index.php?module=".$mod."\">".$modName."</a>\n";
    $str .= "</div>\n";
		if ($row != ($num -1)) 
		{
		  $str .= "<div class=\"siteNavHistoryImg\">\n";	
      $str .= "<img src=\"".THEME_PATH."/images/navarrow.gif\">\n";
      $str .= "</div>\n";
    }
	}
...
function getTopLevelParent($module) {
	...
	//get the 3rd entry in the array (so we skip "modules/center");
	return $arr[2];
