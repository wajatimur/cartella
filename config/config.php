...
//Database Password
define("DBPASSWORD","nsb2005");

//Database Port
define("DBPORT","5432");

//Database Name
define("DBNAME","cartella");

//Admin email set as return address for system emails
define("ADMIN_EMAIL","azri@nematix.com");

//Full site URL.  Must have trailing slash!
define("SITE_URL","http://localhost/cartella/");

//Full site path.  No trailing slash required
define("SITE_PATH","/var/www/cartella");
...
//Default language for users (not used currently)
...
//Paginate results of browse mode
//define("BROWSE_PAGINATE","1");
...
//Turn on DSO Framer editor (IE Only)
